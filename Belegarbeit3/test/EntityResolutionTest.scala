...
class EntityResolutionTest  extends FunSuite with BeforeAndAfterAll{
  ...
  //var idfs_Small:Map[String, Double]= _
  //var amazon_small:RDD[(String, String)]= _
  //var google_small:RDD[(String,String)]= _
  //var goldStandard:RDD[(String,String)]= _
  //val stopwords:Set[String]= Utils.getStopWords(stopwordsFile)

  override protected def beforeAll() {

    conf= new SparkConf().setMaster("local[4]").setAppName("Beleg3EntityResolution")
